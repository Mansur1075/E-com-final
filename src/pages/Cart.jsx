                            ...
                            <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                                <div className="space-y-6">
                                    ...
                                    {cartData.length > 0 ?
                                        ...
                                        cartData.map((item) =>
                                            <div className="rounded-lg border border-gray-200 ml-42 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                                    ...
                                                    <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <button onClick={() => handleCartItemRemove(item)}
                                                                type="button"
                                                                className="inline-flex bg-[black] p-[4px] pr-[10px] mt-3 items-center text-sm font-medium text-red-600 rounded-[4px] dark:text-red-500"
                                                            >
                                                                <svg
