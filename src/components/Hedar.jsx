                ...
                <div className=" lg:flex items-center">
                    ...
                    <div className="w-full lg:w-10/12 py-3 px-3 text-center">
                        <ul className={`lg:flex gap-7 justify-center duration-300 ease-in-out ${menu == true ? "bg-[#00000040] rounded-2xl opacity-100 lg:h-[0px] h-[200px]"
                            ...
                            <li className='font-dm text-[16px] text-[#767676] hover:text-[#262626] pt-7 lg:pt-0 leading-0 py-1 duration-300 ease-in-out hover:font-bold  cursor-pointer '>Home</li>
                            <li className='font-dm text-[16px] text-[#767676] hover:text-[#262626] pt-6 lg:pt-0  leading-0  py-1 duration-300 ease-in-out hover:font-bold  cursor-pointer '>Shop</li>
