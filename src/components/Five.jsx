    ...
    <div>
      <Container>
        <div className="pt-0 pb-8 gap-3  ">
          <div className="">
            <h1 className='text-[#262626] text-[39px] font-dm font-bold cursor-pointer '>New Arrivals</h1>
          </div>
          <div className="five">
          <Slider {...settings}>
          <div className="w-3/12  relative overflow-hidden group p-4 rounded-2xl">
          <img src={ppw} alt="" className='w-full' />
          <div className="">
            <button className='px-[20px] py-[5px] bg-[black] text-[#fff] absolute top-[8%] left-[10%] cursor-pointer '>New</button>
          </div>
          <div className="W-3/12 bg-[#fff]  top-[144px]  absolute left-[-100%] h-[40%] w-full cursor-pointer  group-hover:left-[0px] duration-300 ease-in-out" >
          ...
          <div className="w-3/12  relative overflow-hidden group p-4">
          <img src={ppo} alt="" className='w-full' />
          <div className="">
            <button className='px-[20px] py-[5px] bg-[black] text-[#fff] absolute top-[8%] left-[10%] cursor-pointer '>New</button>
          </div>
          <div className="W-3/12 bg-[#fff]  top-[144px]  absolute left-[-100%] h-[40%] w-full cursor-pointer  group-hover:left-[0px] duration-300 ease-in-out" >
          ...
          <div className="w-3/12  relative overflow-hidden group p-4">
          <img src={ppr} alt="" className='w-full' />
          <div className="">
            <button className='px-[20px] py-[5px] bg-[black] text-[#fff] absolute top-[8%] left-[10% cursor-pointer ]'>New</button>
          </div>
          <div className="W-3/12 bg-[#fff]  top-[144px]  absolute left-[-100%] h-[40%] w-full cursor-pointer  group-hover:left-[0px] duration-300 ease-in-out" >
